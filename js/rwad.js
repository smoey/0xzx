...
.buybtc {
    ...
    line-height: 50px;
    border-radius: 3px;
    box-shadow: 0 0 17px rgb(224 224 224 / 49%);
    background: url(https://0xzx.com/img/coinzilla-fav.png) no-repeat #fff;
    background-position: top 7px left 3px;
}
.buybtc:hover {
	background: url(https://0xzx.com/img/coinzilla-fav.png) no-repeat #000;
    background-position: top 7px left 3px;
}
.swap {
    font-size: 18px;
